  ...
  for (order_number in 1:order_number_max) {
    ...
    if (with_plots) {
      ...
      plot <- ggplot(data = df_pc_projection, aes(x = projection)) +
        ...
        geom_vline(xintercept = upper_quantile, linewidth = 0.8, linetype = "dashed", colour = "darkgreen") +
    ...
    if (with_plots) {
      plot <- ggplot(data = tibble(value = annualized_simulations_copula_hist), aes(x = value)) +
        ...
        geom_density(colour = "blue", linewidth = 0.8) +
        geom_vline(xintercept = upper_quantile_copula, linewidth = 0.8, linetype = "dashed", colour = "darkgreen") +
    ...
    if (with_plots) {
      plot <- ggplot(data = tibble(value = annualized_simulations_ar_hist), aes(x = value)) +
        ...
        geom_density(colour = "blue", linewidth = 0.8) +
        geom_vline(xintercept = as.numeric(upper_quantile_ar), linewidth = 0.8, linetype = "dashed", colour = "darkgreen") +
